...
while True:
   try:
      mode = int(raw_input(colored(' => Select => CB_Online_All(2) CB_Online_Wanted(1) CB_Wanted(0) => ', 'white', 'on_blue')))
      print
      break
   except ValueError:
  ...
  while True:
     try:
        ...
        for (num,value) in enumerate(modellist):
           print ' =>',(num+1),value[:-1]
        print
        mn = int(raw_input(colored(' => Select CB Wanted Model => ', 'white', 'on_blue')))
        print
  ...
  while True:
     try:
        ...
        for (num,value) in enumerate(modellist):
           print ' =>',(num+1),value[:-1]
        print
        mn = int(raw_input(colored(' => Select CB Online Wanted Model => ', 'white', 'on_blue')))
        print
...
if mod == 'CBOA':
  while True:
     try:
        cboa = int(raw_input(colored(' => Select => <500(0) <1000(1) <1500(2) <2000(3) <2500(4) <3000(5) <3500(6) => ', 'white', 'on_blue')))
        print
        break
     except ValueError:
        print(colored('\n => Input must be a number <=\n', 'white', 'on_red'))
    ...
    while True:
       try:
          ...
          for (num, value) in enumerate(modellist):
            ...
            print ' =>',(num+1),value[:-1]
          print
          mn = int(raw_input(colored(' => Select CB Online All Model => ', 'white', 'on_blue')))
          print
 ...
 if 'u0022offline' not in dec:
   ...
   if 'public' in status:
      ...
      while True:
         try:
            print
            prog = int(raw_input(colored(' => Mode => Exit(5) => URL(4) => YTDL(3) => SL(2) => FF-FLV(1) => FF-VIEW(0) => ', 'white', 'on_blue')))
            break
         except ValueError:
            print
      ...
      if prg == 'FF-VIEW':
         ...
         while True:
            try:
               prog = int(raw_input(colored(' => Mode => URL(4) => YTDL(3) => SL(2) => FF-FLV(1) => Exit(0) => ', 'white', 'on_blue')))
               break
            except ValueError:
               print
               print(colored(' => Input must be a number <=', 'white', 'on_red'))
