# Chaturbate FFPLAY/YOUTUBE-DL Anonymous Freechat Recorder v.1.0.7 by horacio9a for Python 2.7.14
# coding: utf-8
  ...
  if len(hlsurl1) > 180:
   ...
   if len(hlsurl1) > 1:
      ...
      while True:
         try:
            print
            mode = int(raw_input(colored(" => Select => (1) FFPLAY or (0) YTDL-REC => ", "yellow", "on_blue")))
            break
         except ValueError:
