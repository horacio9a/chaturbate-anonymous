...
ECHO ###################################################################################
ECHO.
SET /P MODE=EXIT(7) CBYTR(6) CBLSR(5) CBSLR(4) CBFFR(3) CB(2) GETOW(1) GETOA(0)(ENTER)(%MODE%): 
IF "%MODE%"=="" GOTO GETOA
...
COLOR 0F
cd -cba-py
python CB_getOnlineAllModels.py > CB_Online_All.txt
ECHO.
PAUSE
GOTO START
:GETOW
...
COLOR 0F
cd -cba-py
python CB_getOnlineWantedModels.py > CB_Online_Wanted.txt
ECHO.
PAUSE
GOTO START
:CB
